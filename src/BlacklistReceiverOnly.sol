...
contract BlacklistReceiverOnly is IBlacklist, IGuardERC20, AccessManaged {
    ...
    function check(address, address recipient, uint256) external view {
        if (isBlacklisted[recipient]) revert Blacklisted(recipient);
    }
